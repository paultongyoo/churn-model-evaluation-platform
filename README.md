...
| `.env` | <ul><li>Contains the following environment variables:<ul><li>Optuna DB Connection URL</li><li>MLflow, Optuna, Prefect, Evidently, and Grafana UI URLs</li><li>Prefect Server API URL</li><li>Your Project ID</li></ul></li></ul> |
