...
| 📈 **Model Monitoring** | <ul><li>[Evidently.ai ↗](https://www.evidentlyai.com/) integration enables automated data drift and model performance reporting for each load of new churn data.</li><li>Pre-built [Grafana ↗](https://grafana.com/grafana/) dashboard enables montoring data drift and performance over time to assess model development needs.</li></ul> |
