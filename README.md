...
| 📈 **Model Monitoring** | <ul><li>[Evidently.ai ↗](https://www.evidentlyai.com/) integration enables automated data drift and model performance reporting for each load of new churn data.</li><li>Pre-built [Grafana ↗](https://grafana.com/grafana/) dashboard enables montoring data drift and performance over time to help distinguish drift anomalies from signals indicating model development is needed.</li></ul> |
